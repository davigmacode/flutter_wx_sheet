...
class WxSheetStyle with Diagnosticable {
  ...
  /// [WxSheetStyle] with a default value for circle shape.
  const WxSheetStyle.circle({
    double? radius,
    double? minRadius,
    double? maxRadius,
    this.direction,
  ...
  /// [WxSheetStyle] with a default value for full width.
  const WxSheetStyle.block({
    this.direction,
    this.variant,
    this.size,
    this.severity,
