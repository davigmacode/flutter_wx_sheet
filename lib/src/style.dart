...
class WxSheetStyle with Diagnosticable {
  ...
  /// Create [WxSheetStyle] with default value for toned style.
  const WxSheetStyle.tonal({
    Color? color,
    this.severity,
    this.width,
    this.height,
  ...
  /// Create [WxSheetStyle] with default value for filled style.
  const WxSheetStyle.filled({
    Color? color,
    this.severity,
    this.width,
    this.height,
  ...
  /// Create [WxSheetStyle] with default value for elevated style.
  const WxSheetStyle.elevated({
    Color? color,
    this.severity,
    this.width,
    this.height,
  ...
  /// Create [WxSheetStyle] with default value for outlined style.
  const WxSheetStyle.outlined({
    Color? color,
    this.severity,
    this.width,
    this.height,
